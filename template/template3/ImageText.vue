<template>
  ...
  <div class="jokard-template-image-text flex gap-2 bg-white overflow-hidden" :class="values.viewType === 'Text-Image' ? 'flex-col pt-5' : 'flex-col-reverse pb-5' ">
    <div class="px-2">
    <h2 :class="
        preview
    ...
    <div class="bg-muted h-[450px]">
      <NuxtImg
          height="500"
          width="800"
          :src="generateUrlFile(values.image[0]!.path)"
